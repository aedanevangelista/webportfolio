...
const About = () => {
  ...
  let timelineCardContainer =
    "w-full h-full hover:bg-sky-600/95 bg-sky-500 transition-all duration-300 rounded-sm p-2 md:pl-4";
  ...
  return (
    <div
      name="about"
      className="w-full h-full pt-20 bg-slate-900/[99%] text-gray-400"
    >
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div>
            <p>
              ...
              MERN stack and TailwindCSS. With a keen eye for detail and a love
              for crafting seamless and responsive user experiences, I strive to
              bring ideas to life through the power of code.
            </p>
          </div>
        </div>
              ...
              <div className="col-span-8 sm:col-span-4 w-full h-full py-4 sm:hover:scale-105 transition-all duration-500">
                <div class={timelineCardContainer}>
                  ...
                  <p class={timelineP}>
                    ...
                    college. Ensuring that I finish all the client's task at the
                    given deadline.
                  </p>
              ...
              <div className="hidden sm:block col-span-4 w-full h-full hover:scale-105 transition-all duration-500">
                <div className={timelineCardContainer}>
                  ...
                  <p className={timelineP}>
                    ...
                    pick myself up again and tried to become a technical support
                    for the meantime. Got to improve my english communication
                    skills that I still use up to this date as a developer.
                  </p>
                </div>
              </div>
